...
int init_conn_lan(void *conn, const char *ip) { return 0; }

int send_chunk_lan(void *conn, const struct chunk *chunk) { return 0; }

int recv_chunk_lan(void *conn, struct chunk *chunk) { return 0; }